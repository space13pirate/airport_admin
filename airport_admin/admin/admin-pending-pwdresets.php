...
if (isset($_GET['del'])) {
    $id = intval($_GET['del']); // Получение идентификатора запроса для удаления
    // Подготовка SQL-запроса на удаление
    $adn = "delete from airport_passwordresets where pwd_id=?";
    ...
    $stmt->close();
    if ($stmt) {
        $succ = "Запрос на сброс пароля отклонён";
    } else {
...
<div class="be-wrapper be-fixed-sidebar">
    ...
    <div class="be-content">
        <div class="page-head">
            <h2 class="page-head-title">Ожидание сброса пароля</h2>
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb page-head-nav">
                    ...
                    <li class="breadcrumb-item active">Ожидающие</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="card card-table">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                                ...
                                <tbody>
                                <?php
                                $ret = "SELECT * FROM `airport_passwordresets` where status !='Approved'";
                                    ...
                                    <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                                        ...
                                        <td class="center">
                                            <a class="badge badge-success"
                                               href="admin-confirm-pwdresets.php?pwd_id=<?php echo $row->pwd_id; ?>">Подтвердить запрос</a>
                                            <hr>
                                            <a class="badge badge-danger"
                                               href="admin-pending-pwdresets.php?del=<?php echo $row->pwd_id; ?>">Удалить запрос</a>
                                        </td>
                                    </tr>
                                    <?php $cnt = $cnt + 1;
                                } ?>
